...
procedure RaiseCipherException(const ErrorCode: Integer; const SFS: AnsiString);
...
aaWriteToLog('SFSCipher> initialization started');
{$ENDIF}
...
{$IFDEF DEBUG_LOG_INIT}
aaWriteToLog('SFSCipher> initialization finished');
{$ENDIF}
