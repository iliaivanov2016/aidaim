...
// Unit SFSCompress - compression routines on the basis of the ECL 1.1
...
uses Sysutils, Classes,SFSEngine
{$IFDEF ZLIB}
 {$IFDEF X64_ON}
 ,SFSZlib_64
 {$ELSE}
...
type
 TSFSCompressionLevel1 = (sfsNone, zlibFastest, zlibNormal, ppmNormal, ppmMax,
...
function SFSInternalCompressBuffer(inBuf  : PAnsiChar;
                          inSize : Integer;
                          out outBuf : PAnsiChar;
                          out outSize    : Integer;
                          compressionLevel : TSFSCompressionLevel1 = zlibFastest) : Boolean;
...
function SFSInternalDecompressBuffer(inBuf  : PAnsiChar;
                            inSize : Integer;
                            out outBuf : PAnsiChar;
                            out outSize: Integer;
                            compressionLevel : TSFSCompressionLevel1 = zlibFastest) : Boolean;
...
function SFSInternalGetBlockSize(compressionLevel: TSFSCompressionLevel1): Integer;
