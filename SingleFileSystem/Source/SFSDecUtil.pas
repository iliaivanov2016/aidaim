...
aaWriteToLog('SFSDecUtil> initialization started');
{$ENDIF}
{$IFDEF D16H}
//
{$ELSE}
...
{$IFDEF DEBUG_LOG_INIT}
//aaWriteToLog('SFSDecUtil> CPU type = '+IntToStr(FCPUType));
{$ENDIF}
  SwapInteger       := SwapInt; //!!
...
{$IFDEF DEBUG_LOG_INIT}
aaWriteToLog('SFSDecUtil> Before CRC32:');
if InitTestIsOk
then
...
{$IFDEF DEBUG_LOG_INIT}
aaWriteToLog('SFSDecUtil> After CRC32:');
if InitTestIsOk
then
aaWriteToLog('InitTestIsOk')
else
...
{$IFDEF DEBUG_LOG_INIT}
aaWriteToLog('SFSDecUtil> initialization finished');
{$ENDIF}

finalization
{$IFDEF DEBUG_LOG_INIT}
aaWriteToLog('SFSDecUtil> finalization started');
{$ENDIF}
{$IFDEF D16H}
//
{$ELSE}
...
{$ENDIF}
  ...
  FStrFMTs := nil;
{$IFDEF DEBUG_LOG_INIT}
aaWriteToLog('SFSDecUtil> finalization finished');
{$ENDIF}
end.
