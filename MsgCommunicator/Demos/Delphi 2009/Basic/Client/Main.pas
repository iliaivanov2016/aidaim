...
procedure TForm1.MsgClient1ReceiveTextMessage(const FromUserID: Cardinal; const SendingDate,DeliveryDate: TDateTime; const Text: AnsiString);
begin
...
procedure TForm1.MsgClient1ReceiveUnicodeTextMessage(const FromUserID: Cardinal;
  const SendingDate, DeliveryDate: TDateTime; const Text: WideString);
begin
 while not Canvas.TryLock do
  sleep(0);
