...
#include "MsgDatabaseMySQLDAC.hpp"
...
#include "uRegister.h"
#include "uStart.h"
#include "MsgDatabaseTempTableSQLMemTable.hpp"
#include <DB.hpp>
...
__published:	// IDE-managed Components
  ...
  TTimer *Timer1;
	...
	TMsgDatabaseMySQLDAC *MsgDatabaseMySQLDAC1;
	TMsgTempTableSQLMemTable *MsgTempTableSQLMemTable1;
  ...
  void __fastcall bnHistoryClick(TObject *Sender);
	void __fastcall MsgClient1ReceiveUnicodeTextMessage(const DWORD FromUserID, const TDateTime SendingDate,
...
private:	// User declarations
    ...
    TStringList *FTemp;
    Msgcriticalsection::TRTLCriticalSection FCSect;
    bool FStarting;
