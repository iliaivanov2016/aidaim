...
procedure TfmMain.MsgServer1ReceiveTextMessage(const FromUserID: Cardinal; const SendingDate,DeliveryDate: TDateTime; const Text: AnsiString);
var
  str:          AnsiString;
...
begin
  ...
  sdt := TServerDisplayThread.Create(str);
  sdt.Resume;
