...
begin
  MsgServer1.ConnectionParams.NetworkSettings.SetDefaultSettings(msgLocal);
  SetParams;
// grids headers
...
procedure TForm1.MsgServer1ReceiveTextMessage(const FromUserID: Cardinal; const SendingDate,DeliveryDate: TDateTime; const Text: String);
var
  str:          String;
