{***************************************************************}
{                                                               }
{     BZIP2 Data Compression Interface Unit for Kylix / Delphi  }
{                                                               }
...
//------------------------------------
// Modified by AidAim Software, 2003
// http://www.aidaim.com
//------------------------------------
...
procedure BZCompressBuf(const InBuf: Pointer; InBytes: Integer;
  out OutBuf: Pointer; out OutBytes: Integer; const CompressionMode: Integer);
...
{$IFDEF LINUX}
const
  bz2so = 'libbz2.so.1.0.0';
{$ENDIF}

procedure _BZ2_hbMakeCodeLengths;
{$IFDEF LINUX}
  cdecl; external bz2so name 'BZ2_hbMakeCodeLengths';
{$ENDIF}
{$IFDEF MSWINDOWS}
  external;
{$ENDIF}

procedure _BZ2_blockSort;
{$IFDEF MSWINDOWS}
  external;
{$ENDIF}
{$IFDEF LINUX}
  cdecl; external bz2so name 'BZ2_blockSort';
{$ENDIF}

procedure _BZ2_hbCreateDecodeTables;
{$IFDEF MSWINDOWS}
  external;
{$ENDIF}
{$IFDEF LINUX}
  cdecl; external bz2so name 'BZ2_hbCreateDecodeTables';
{$ENDIF}

procedure _BZ2_hbAssignCodes;
{$IFDEF MSWINDOWS}
  external;
{$ENDIF}
{$IFDEF LINUX}
  cdecl; external bz2so name 'BZ2_hbAssignCodes';
{$ENDIF}

procedure _BZ2_compressBlock;
{$IFDEF MSWINDOWS}
  external;
{$ENDIF}
{$IFDEF LINUX}
  cdecl; external bz2so name 'BZ2_compressBlock';
{$ENDIF}

procedure _BZ2_decompress;
{$IFDEF MSWINDOWS}
  external;
{$ENDIF}
{$IFDEF LINUX}
  cdecl; external bz2so name 'BZ2_decompress';
{$ENDIF}
...
{$ENDIF} 
{$IFDEF LINUX} 
  cdecl; external bz2so name 'BZ2_bzCompressInit'; 
{$ENDIF}
 
function BZ2_bzCompress(var strm: TBZStreamRec; action: Integer): Integer; stdcall;
{$IFDEF MSWINDOWS} 
  external; 
{$ENDIF}
{$IFDEF LINUX}
  cdecl; external bz2so name 'BZ2_bzCompress';
{$ENDIF} 
	
function BZ2_bzCompressEnd(var strm: TBZStreamRec): Integer; stdcall;
{$IFDEF MSWINDOWS} 
  external; 
{$ENDIF}
{$IFDEF LINUX}
  cdecl; external bz2so name 'BZ2_bzCompressEnd'; 
{$ENDIF}
 
function BZ2_bzBuffToBuffCompress(dest: Pointer; var destLen: Integer; source: Pointer; 
  sourceLen, blockSize100k, verbosity, workFactor: Integer): Integer; stdcall;
{$IFDEF MSWINDOWS} 
  external;
{$ENDIF}
{$IFDEF LINUX} 
  cdecl; external bz2so name 'BZ2_bzBuffToBuffCompress'; 
{$ENDIF}
...
{$ENDIF}
{$IFDEF LINUX}
  cdecl; external bz2so name 'BZ2_bzDecompressInit';
{$ENDIF}
...
{$ENDIF}
{$IFDEF LINUX}
  cdecl; external bz2so name 'BZ2_bzDecompress'; 
{$ENDIF}
...
{$ENDIF}
{$IFDEF LINUX}
  cdecl; external bz2so name 'BZ2_bzDecompressEnd';
{$ENDIF}

function BZ2_bzBuffToBuffDecompress(dest: Pointer; var destLen: Integer; source: Pointer;
  sourceLen, small, verbosity: Integer): Integer; stdcall;
{$IFDEF MSWINDOWS}
  external;
{$ENDIF}
{$IFDEF LINUX}
  cdecl; external bz2so name 'BZ2_bzBuffToBuffDecompress';
{$ENDIF}
...
begin
  ...
  try
    ...
    CCheck(BZ2_bzCompressInit(strm, CompressionMode, 0, 0));
    try
