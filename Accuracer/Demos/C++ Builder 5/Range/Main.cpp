...
{
 ACRTable1->IndexName = "ByCompany";
 ACRTable1->SetRangeStart();
 ACRTable1->FieldByName("Company")->AsString = cmbStartRange->Text;
 ACRTable1->KeyExclusive = cbStartKeyExclusive->Checked;
 ACRTable1->SetRangeEnd();
 ACRTable1->FieldByName("Company")->AsString = cmbEndRange->Text;
 ACRTable1->KeyExclusive = cbEndKeyExclusive->Checked;
 ACRTable1->ApplyRange();
