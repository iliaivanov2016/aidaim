...
Accuracer ODBC Driver D2009 Demo: README
========================================
...
Program Name:
  Accuracer ODBC Driver CB2009 Demo
Program Version:
  1.00
Program Release Date:
  06/18/2009
Program Purpose:
  Shows an example of working with Accuracer ODBC Driver via BDE.
Tested Environment:
...
1) Please, read Demos/Test/ReadMe.txt file and do the steps 1, 2, 3 from
   'How to run' chapter.

2) Open, compile and run Project1.dpr.

Note, Graphic fields are not supported yet.
