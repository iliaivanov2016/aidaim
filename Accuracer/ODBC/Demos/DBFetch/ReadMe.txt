...
Accuracer ODBC Driver DBFetch Demo: README
==========================================
...
Program Name:
  Accuracer ODBC Driver DBFetch Demo
Program Version:
  1.00
Program Release Date:
  07/16/2003
Program Purpose:
  Illustrates use of Accuracer ODBC Driver by MFC in VC++.NET
Tested Environment:
  MS Visual C++ .Net
...
1) Open DBFetch.sln in Visual Studio and compile it 

2) Install Accuracer ODBC Driver. See Installation chapter in the product readme.txt

3) Create User DSN with name Accuracer_DBFetch and specify a path to the dbfetch.adb file 
in this test folder
...
If the problem persists, please, inform us about the following:
  ...
  - Application which is used with the products
