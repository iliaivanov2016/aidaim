...
Skip:
          case Family of
            ...
            cfPentium:
              case Model of
                ...
                8: Result := Result + 'Pentium' + ' P5' + '5C' + ' (0.25 m)';
              else
            ...
            cfPentiumPro:
              case Model of
                ...
                3: Result := Result + 'Pentium' + ' II' + ' (0.28 m)';
                5: begin
                     Result := Result + 'Pentium' + ' II' + ' (0.25 m)';
                     case L2Cache of
              ...
              7,8: begin
                     ...
                     if Model = 7 then Result := Result + ' (0.25 m)'
                       else Result := Result + ' (0.18 m)';
                   end;
          ...
          case Family of
            ...
            cfPentium:
              case Model of
                ...
                6: Result := Result + 'K6' + ' (0.30 m)';
                7: Result := Result + 'K6' + ' (0.25 m)';
            ...
            cfPentiumPro:
              case Model of
                1: Result := Result + 'K7' + ' Athlon' + ' (0.25 m)';
                2: Result := Result + 'K7' + ' Athlon' + ' (0.18 m)';
      ...
      cvRise:
        begin
          ...
          if Family = cfPentium then
            case Model of
              0: Result := Result + 'mP6' + ' (0.25 m)';
              2: Result := Result + 'mP6' + ' (0.18 m)';
            else
              goto Unknown;
            end
          else goto Unknown;
