...
procedure ZLIBCompressBuf(
                      const InBuf: PAnsiChar; InBytes: Integer;
...
{ DecompressBuf decompresses data, buffer to buffer, in one call.
  ...
  Out: OutBuf = ptr to newly allocated buffer containing decompressed data
       OutBytes = number of bytes in OutBuf   }
procedure ZLIBDecompressBuf(const InBuf: PAnsiChar; InBytes: Integer;
...
procedure ZLIBCompressBuf(const InBuf: PAnsiChar; InBytes: Integer;
                      out OutBuf: PAnsiChar; out OutBytes: Integer;
                      compMode: Byte = 1
                      );
var
