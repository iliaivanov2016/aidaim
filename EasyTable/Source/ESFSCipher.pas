...
procedure RaiseCipherException(const ErrorCode: Integer; const ESFS: AnsiString);
...
var
  E: ECipherException;
begin
  E := ECipherException.Create(ESFS);
...
aaWriteToLog('ESFSCipher> initialization started');
{$ENDIF}
...
{$IFDEF DEBUG_LOG_INIT}
aaWriteToLog('ESFSCipher> initialization finished');
{$ENDIF}
