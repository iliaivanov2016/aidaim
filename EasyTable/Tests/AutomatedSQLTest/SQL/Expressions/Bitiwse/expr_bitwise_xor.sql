...
select int1, int2, int1 XOR int2 as int3, int2 ^ int1 as int4 from test1 order by int1;
#DBISAM
#exec
...
#exec
insert into test1  values (16,16,0);
#exec
insert into test1  values (8,4,12);
#exec
insert into test1  values (2,1,3);
#exec
insert into test1  values (3,2,1);
