...
EasyTable ODBC Driver Test: README
==================================
...
Program Name:
  EasyTable ODBC Driver Test
Program Version:
  1.00
Program Release Date:
  07/16/2003
Program Purpose:
  Shows an example of EasyTable ODBC Driver work in comparison with EasyTable.
Tested Environment:
...
1) Install EasyTable ODBC Driver. See Installation chapter in the product readme.txt

2) Create User DSN with name Test and specify a path to the test.edb file 
in this test folder

3) Create Database Alias with name Test and specify the DSN you created

5) Open test.dpr in Delphi and compile it 

6) Run test.exe and click Open Database buttons
