...
type
  TMainForm = class(TForm)
    ...
    procedure cbFindWhenNoFilterClick(Sender: TObject);
  private
...
procedure TMainForm.cbFindWhenNoFilterClick(Sender: TObject);
begin
 EasyTable1.BDELikeFilter := not cbFindWhenNoFilter.Checked;
end;
