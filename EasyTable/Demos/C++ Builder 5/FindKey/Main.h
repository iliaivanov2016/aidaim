...
__published:	// IDE-managed Components
        ...
        TButton *btFindKey;
        TButton *btFindNearest;
        TButton *btGotoKey;
        TButton *btGotoNearest;
        TLabel *Label1;
  TEasyDatabase *EasyDatabase1;
        ...
        void __fastcall btFindKeyClick(TObject *Sender);
        void __fastcall btFindNearestClick(TObject *Sender);
        void __fastcall btGotoKeyClick(TObject *Sender);
        void __fastcall btGotoNearestClick(TObject *Sender);
