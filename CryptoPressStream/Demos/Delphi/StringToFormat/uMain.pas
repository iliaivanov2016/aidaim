...
begin
 reEncoded.Text := CPSManager1.AnsiStringToFormat(reSource.Text,TCPSStringFormat(rgFormats.ItemIndex));
...
begin
 reDecoded.Text := CPSManager1.FormatToAnsiString(reEncoded.Text,TCPSStringFormat(rgFormats.ItemIndex));
end;
